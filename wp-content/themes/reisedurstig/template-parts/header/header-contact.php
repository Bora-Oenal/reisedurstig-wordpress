    ...
    <body>
        ...
        <div class="position-relative overflow-hidden">
            <div class="d-flex min-vh-100 video-cnt" lc-helper="video-bg">
                ...
                <?php
                // Holen der Hero Video Einstellung für die Kontakt-Seite
                $hero_video_contact_id = get_theme_mod( 'hero_video_contact_id' ); // Hier wird die Kontakt-Seite Einstellung verwendet
                
                // Die URL des ausgewählten Hero Videos erhalten
                $hero_video_contact_url = wp_get_attachment_url( $hero_video_contact_id );
                
                // Wenn eine URL vorhanden ist, das Video anzeigen
                if ( ! empty( $hero_video_contact_url ) ) :
                ?>
                    <video
                        ...
                        playsinline="">
                        <source
                            src="<?php echo esc_url( $hero_video_contact_url ); ?>"
                            type="video/mp4">
                    </video>
                <?php endif; ?>
            ...
            <!-- Video -->
                <!-- <video
                    ...
                    loop=""
                    playsinline="">
                    <source src="<?php echo get_template_directory_uri(); ?>/assets/videos/waterfall-beautiful.mp4" type="video/mp4">
                </video> -->
