    ...
    <body>
        ...
        <div class="position-relative overflow-hidden">
            <div class="d-flex min-vh-100 video-cnt" lc-helper="video-bg">
                ...
                $hero_video_archive_insel_id = get_theme_mod( 'hero_video_archive_insel_id' );

                // Die URL des ausgewählten Hero Videos erhalten
                $hero_video_archive_insel_url = wp_get_attachment_url( $hero_video_archive_insel_id );

                // Wenn eine URL vorhanden ist, das Video anzeigen
                if ( ! empty( $hero_video_archive_insel_url ) ) :
                ?>
                    <video
                        ...
                        playsinline="">
                        <source
                            src="<?php echo esc_url( $hero_video_archive_insel_url ); ?>"
                            type="video/mp4">
                    </video>
                <?php endif; ?>
